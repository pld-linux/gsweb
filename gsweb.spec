...
GNUstepWeb to biblioteka zaprojektowana by być kompatybilną z
WebObjects 4.x (stworzoną przez NeXT (teraz Apple) Inc.).

Ta biblioteka jest logicznym rozszerzeniem projektu GNUstep. Powinna
pomóc Objective-C, OpenStepowi i WebObjects w staniu się standardami.
...
Pliki nagłówkowe biblioteki gsweb.
